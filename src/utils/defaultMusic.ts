...
import wonder from '@utils/music/default/Shawn-Mendes-Wonder.mp3';
...
import secret from '@utils/music/default/Joshua-Bassett-Secret.mp3';

export default [savages, ifICantHaveYou, wonder, happier, honestly, anxiety, peopleWatching, hunger, secret, rescueMe];